...
const services = [
  { icon: "leaf-outline", title: "Ayurvedic Consultation", description: "Personalized guidance for your wellness needs." },
  { icon: "flower-outline", title: "Panchakarma Therapies", description: "Traditional therapies for holistic care." },
  { icon: "locate-outline", title: "Acupuncture", description: "Targeted therapy to support comfort and balance." },
  { icon: "nutrition-outline", title: "Naturopathy", description: "Natural approaches to everyday well-being." },
  { icon: "body-outline", title: "Yoga Therapy", description: "Movement, breathing and mindful living." },
  { icon: "sparkles-outline", title: "Beauty & Cosmetic Wellness", description: "Personalized beauty and skin care services." },
];
...
<PatientHeader onMenuPress={() => setMenuOpen(true)} />
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        {/* SERVICES — SIMPLE TWO-COLUMN CARDS */}
        <View style={styles.servicesSection}>
          <View style={styles.servicesHeadingRow}>
            <View style={styles.servicesHeadingAccent} />
            <Text style={styles.servicesEyebrow}>OUR SERVICES</Text>
          </View>
          <Text style={styles.servicesTitle}>Everything You Need, In One Place</Text>
          <Text style={styles.servicesLead}>
            Explore our wellness therapies and find the care that suits you.
          </Text>
            ...
            {services.map((item) => (
              ...
              >
                <View style={styles.serviceIcon}>
                  <Ionicons name={item.icon as any} size={23} color={GREEN} />
                </View>
                <Text style={styles.serviceText}>{item.title}</Text>
                <Text style={styles.serviceDescription}>{item.description}</Text>
                <View style={styles.serviceLink}>
                  <Text style={styles.serviceLinkText}>Explore</Text>
                  <Ionicons name="arrow-forward" size={14} color={GREEN_3} />
                </View>
              </TouchableOpacity>
            ))}
          </View>
